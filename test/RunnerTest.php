    ...
    public function testRunnerStopsOnCommandFailure(): void {
        ...
        $executerMock
            ...
            ->willReturnOnConsecutiveCalls(
                ...
                $this->createRanCommand('GIT_SSH_COMMAND="ssh -i /test-keys/test-key-name" git --git-dir=' . escapeshellarg($this->deployGitDir()) . ' --work-tree=' . escapeshellarg($this->repoPath()) . ' fetch --force origin main:refs/remotes/origin/main', [], 0), // fetch - builtInCommands
